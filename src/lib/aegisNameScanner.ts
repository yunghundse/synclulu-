...
const BUILT_IN_BLACKLIST: BlockedKeyword[] = [
  ...
  { keyword: 'delulu_team', category: 'IMPERSONATION', severity: 'CRITICAL', isRegex: false, isActive: true },
  { keyword: 'delulu_support', category: 'IMPERSONATION', severity: 'CRITICAL', isRegex: false, isActive: true },
  { keyword: 'deluluapp', category: 'IMPERSONATION', severity: 'HIGH', isRegex: false, isActive: true },
