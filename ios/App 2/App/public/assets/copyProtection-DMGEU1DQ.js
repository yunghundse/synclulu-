...
📧 Kontakt: legal@butterbread.de`,"color: #666; font-size: 14px; line-height: 1.8;")},s=()=>{const e=document.createElement("div");e.id="delulu-watermark",e.style.cssText=`
    position: fixed;
    pointer-events: none;
    z-index: 9999;
    opacity: 0.03;
